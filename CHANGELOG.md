...
### Changed
- README 目标读者扩展：研究者 / 古建筑爱好者 / 需要快速制作古建模型的创作者（中英同步）
- 全库 Markdown 排版清理：合并句中软换行（中文渲染会插入空格），17 个文件纯排版修订

### Added
- `docs/users.md` 新增用户三画像（古建筑爱好者 / 模型创作者），与 README
  目标读者口径对齐；开放问题更新为三类用户优先级排序
